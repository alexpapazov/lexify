...
export function UndoFab({ show, onUndo }: { show: boolean; onUndo: () => void }) {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full border border-white/10 bg-surface-raised/95 px-4 py-2.5 text-sm font-medium text-ink-muted shadow-lg backdrop-blur transition active:scale-95 hover:text-ink"
    >

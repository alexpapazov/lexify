...
export const TOUR_STEPS: TourStep[] = [
  { path: '/study', anchor: 'due-now', title: 'Study — your home base',
    body: '“Study all due” gathers every card that’s ready for review right now — the number is how many are waiting. Clicking it lets you pick a review type and language, and each row launches straight into the style you’ve chosen in Settings: normal prompts, fill-in-the-blank cloze sentences, or a quick matching round for reverse cards.' },
  ...
  { path: '/practice', anchor: 'practice-words', title: 'Practice — extra reps',
    body: 'Under Study you’ll also find Practice: pick any words — a deck, a folder, starred cards, or a hand-picked set — and drill them with AI-generated fill-in-the-blank sentences or matching rounds. Tap any word in a sentence to see its meaning. Practice never changes your review schedule.' },
  ...
  { path: '/library', anchor: 'library-folders', title: 'Organize & inspect',
    body: 'Try dragging a folder or deck to reorder it. And once you open a deck, any card’s ⓘ menu lets you view and edit its details, audio, schedule — even its cloze sentences.' },
  { path: '/browse', title: 'Browse',
    body: 'This is where you can add sets created by other users to your own library.' },
  { path: '/create', anchor: 'upload-ai-toggle', title: 'Create',
    body: 'Create a new set of cards — name the deck, pick the languages, and paste your word list. Lexify parses it into clean cards to preview before saving, and the AI agent can format or extract messy input for you.' },
  { path: '/agents', title: 'Agents',
    body: 'The hub for agents that can automate making edits to the cards in your library.' },
  { path: '/progress', anchor: 'analytics-views', title: 'Analytics',
    body: 'Your studying in three views: Past shows your review history, Present a snapshot of where every card stands, and Future forecasts your daily review load and vocabulary growth.' },
  ...
  { path: '/settings', anchor: 'settings-ladder', title: 'Learning ladders',
    body: 'The heart of Lexify: the sequence of exercises a card climbs before it graduates — multiple choice, typing, dictation, cloze. Set a default, customize it per language, or switch a language to a branched pathway.' },
